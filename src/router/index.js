        ...
        children: [
            {
                ...
                name: 'markdownlist',
                meta: {title: 'MarkDown列表', icon: 'clipboard'}
            }
        ]
    },
    {
        ...
        children: [
            {
                ...
                name: 'editor',
                meta: {title: '富文本编辑器', icon: 'clipboard'}
            }
        ]
    },
    {
        ...
        children: [
            {
                ...
                name: 'editorlist',
                meta: {title: '富文本编辑器列表', icon: 'clipboard'}
            }
        ]
    },
    {
        ...
        children: [
            {
                ...
                name: 'list',
                meta: {title: '搜索记录详情', icon: 'clipboard'}
            }
        ]
    },
    {
        ...
        children: [
            {
                ...
                name: 'loginloglist',
                meta: {title: '登录日志', icon: 'clipboard'}
            }
        ]
    },
    {
        ...
        children: [
            {
                ...
                name: 'logoutloglist',
                meta: {title: '登出日志', icon: 'clipboard'}
            }
        ]
    },
    {
        ...
        children: [
            {
                ...
                name: 'systemloglist',
                meta: {title: '系统日志', icon: 'clipboard'}
            }
        ]
    },
    {
