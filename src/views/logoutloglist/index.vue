<template>
    <div>
        <div style="text-align: center">
            <el-link type="primary" style="font-size: large">退出日志详情</el-link>
        </div>
        <!--搜索条件-->
        <div>
...
export default {
    ...
    methods: {
        ...
        query: function () {
            var vueThis = this
            axios({
                url: process.env.VUE_APP_BASE_API+"/queryLogoutLogList",
                method: 'post',
            ...
            axios({
                url: process.env.VUE_APP_BASE_API+"/queryLogoutLogListCount",
                method: 'post',
                data: vueThis.queryForm,
            })
                .then(function (response) {
