...
export default {
    ...
    methods: {
        ...
        query: function () {
            ...
            /* axios({
                 url:process.env.VUE_APP_BASE_API+ "/queryUserList",
                 method: 'post',
                 data: vueThis.queryForm,
             })
                 .then(function (response) {
            ...
            /*axios({
                url:process.env.VUE_APP_BASE_API+ "/queryUserListCount",
                method: 'post',
                data: vueThis.queryForm,
            })
                .then(function (response) {
