<template>
    <div>
        <div id="editorlist" style="text-align: center">
            <div style="text-align: center">
                <el-link type="primary" style="font-size: large">富文本编辑器列表</el-link>
            </div>
...
export default {
    ...
    methods: {
        handleClose: function () {
            ...
            axios({
                url:process.env.VUE_APP_BASE_API+ '/deleteeditor',
                method: 'post',
                data: {
        ...
        updateeditor: function () {
            var vueThis = this
            axios({
                url: process.env.VUE_APP_BASE_API+'/updateeditor',
                method: 'post',
                data: {
        ...
        query: function () {
            var vueThis = this
            axios({
                url: process.env.VUE_APP_BASE_API+'/queryEditor',
                method: 'post',
            ...
            axios({
                url: process.env.VUE_APP_BASE_API+'/queryEditorCount',
                method: 'post',
                data: vueThis.queryForm,
            })
                .then(function (response) {
